...
import { h } from 'vue';
import md5 from 'md5';
import { getAdminsApi } from '/@/api/admins/admins';
import { getQueryStrForOneField } from '/@/utils/QueryUtil';
...
export const useUserStore = defineStore({
  ...
  actions: {
    ...
    async getUserInfoAction(data): Promise<UserInfo | null> {
      ...
      //    console.log('getUserInfoAction =if(data=', userInfo);
